...
function App() {
  ...
  const [openAddCardOpen, setOpenProfileOpen] = React.useState(false);
  const [openAvatarOpen, setOpenProfileOpen] = React.useState(false);
  ...
  return (
      <div classNameName="page">
        ...
        <Footer/>   
        <PopupWithForm 
        open= {openProfileOpen} onClose={closeAllPopups} title={'Edit profile'}>
          <>
          <input
                placeholder="Name"
                minLength="2"
